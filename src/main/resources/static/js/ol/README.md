...
```js
import Map from 'static/js/ol/Map';
import View from 'static/js/ol/View';
import TileLayer from 'static/js/ol/layer/Tile';
import XYZ from 'static/js/ol/source/XYZ';
