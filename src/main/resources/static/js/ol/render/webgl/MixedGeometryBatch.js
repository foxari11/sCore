...
/**
 * @typedef {import("../Feature.js").default} RenderFeature
 */
/**
    ...
    switch (type) {
      ...
      case 'MultiPolygon':
        const multiPolygonGeom =
          /** @type {import("../../geom.js").MultiPolygon|RenderFeature} */ (
            geometry
          );
      ...
      case 'Polygon':
        const polygonGeom =
          /** @type {import("../../geom.js").Polygon|RenderFeature} */ (geometry);
        this.addCoordinates_(
          type,
        ...
        break;
      case 'Point':
        const pointGeom = /** @type {import("../../geom.js").Point} */ (geometry);
        this.addCoordinates_(
          type,
