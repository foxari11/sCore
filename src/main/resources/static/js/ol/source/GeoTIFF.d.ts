...
export type GeoTIFF = import("static/js/ol/source/GeoTIFF").GeoTIFF;
export type MultiGeoTIFF = import("static/js/ol/source/GeoTIFF").MultiGeoTIFF;
...
export type GeoTIFFImage = import("static/js/ol/source/GeoTIFF").GeoTIFFImage;
